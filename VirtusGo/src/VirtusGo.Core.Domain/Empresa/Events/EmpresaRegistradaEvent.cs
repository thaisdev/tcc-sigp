...
{
    public class EmpresaRegistradaEvent : BaseEmpresaEvent
    {
        public EmpresaRegistradaEvent(string razaoSocial, string nomeFantasia, string numeroDocumento,
            FlagBloqueadoEnum bloqueado, FlagExcluidoEnum excluido, string email, string email2, string email3,
            string cep, string bairro, string endereco, string uf, string cidade, string contato, string contato2,
