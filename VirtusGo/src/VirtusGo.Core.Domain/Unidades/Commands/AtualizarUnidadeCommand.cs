...
{
    public class AtualizarUnidadeCommand : BaseUnidadeCommand
    {
        public AtualizarUnidadeCommand(string razaoSocial, string fantasia, string documento, string email, string ddd,
