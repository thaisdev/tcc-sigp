...
using VirtusGo.Core.Infra.CrossCutting.Identity.Models.AccountViewModels;
...
namespace VirtusGo.Core.UI.Mvc.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        public AccountController(IDomainNotificationHandler<DomainNotification> notification, IUser user, UserManager<ApplicationUser> userManager, SignInManager<ApplicationUser> signInManager, IEmailSender emailSender, ILogger<AccountController> logger) : base(notification, user)
        {
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var verificarUsuario = _userManager.Users.FirstOrDefault(x => x.Email == model.Email);
...
//                   $"Please reset your password by clicking here: <a href='{callbackUrl}'>link</a>");
                RecuperarSenhaMail.EnviarEmail(user.Email, user.Email, user.Nome, callbackUrl);
                return RedirectToAction(nameof(ForgotPasswordConfirmation));
            }
