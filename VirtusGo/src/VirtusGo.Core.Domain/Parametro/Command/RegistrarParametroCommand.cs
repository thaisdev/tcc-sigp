...
{
    public class RegistrarParametroCommand : BaseParametroCommand
    {
        public RegistrarParametroCommand(int id, int diasParaExpiracaoPontos, double valorComissaoGeral, FlagExcluidoEnum flagExcluido,
