...
{
    public class AtualizarParametroCommand : BaseParametroCommand
    {
        public AtualizarParametroCommand(int id, int diasParaExpiracaoPontos, double valorComissaoGeral, double? valorPorcentagemGeralPontosFaixa, FlagExcluidoEnum flagExcluido,
